...
export default function DashboardPage({ user, onLogout }) {
  ...
  const titleMap = { dashboard:'Dashboard', divisions:'Semua Divisi', documents:'Dokumen', recent:'Dokumen Terbaru', favorites:'Favorit', recycle:'Recycle Bin', activity:'Activity Log', users:'Manajemen User', permissions:'Permission', fileManager:'File Manager' };
