...
export default function DashboardPage({ user, onLogout }) {
  ...
  function handleSearch(term) {
    if (['divisions','fileManager','documents','recent','favorites','activity'].includes(activeView)) {
      setTopSearch(term || '');
      return;
    }
    if (term) {
  ...
  const titleMap = { dashboard:'Dashboard', divisions:'Semua Divisi', documents:'Dokumen', recent:'Dokumen Terbaru', favorites:'Favorit', recycle:'Recycle Bin', activity:'Activity Log', fileManager:'File Manager' };
