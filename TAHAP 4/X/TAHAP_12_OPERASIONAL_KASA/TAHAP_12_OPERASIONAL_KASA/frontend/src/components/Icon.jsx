...
export default function Icon({ name, size = 20 }) {
  ...
  switch (name) {
    ...
    case 'download': return <svg {...props}><path d="M12 3v12M7 10l5 5 5-5"/><path d="M5 21h14"/></svg>;
    case 'history': return <svg {...props}><path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v6h6"/><path d="M12 7v5l3 2"/></svg>;
