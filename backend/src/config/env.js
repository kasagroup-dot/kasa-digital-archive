...
function parseSameSite(value, nodeEnv) {
  ...
  return ['lax','strict','none'].includes(clean) ? clean : fallback;
}
...
export const env = Object.freeze({
  ...
  appVersion: process.env.APP_VERSION || 'FULLSTACK-0.14.0',
  ...
  refreshCookieSameSite: parseSameSite(process.env.REFRESH_COOKIE_SAME_SITE, nodeEnv),
